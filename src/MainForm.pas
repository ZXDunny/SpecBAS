...
begin
  ...
  SP_SetDirtyRect(Min(MOUSEX, MOUSESTOREX), Min(MOUSEY, MOUSESTOREY), Max(MOUSEX+MOUSESTOREW, MOUSESTOREX+MOUSESTOREW), Max(MOUSEY+MOUSESTOREH, MOUSESTOREY+MOUSESTOREH));
