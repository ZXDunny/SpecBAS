...
type
  ...
  Function MakeDataPayload: ansiString;
  Procedure UnpackPayLoad(Const Payload: ansiString);

implementation

uses
  ActiveX, SP_Tokenise, SP_Util;
...
var
  i: Integer;
Begin
  Result := LongWordToString(SP_Program_Count);
