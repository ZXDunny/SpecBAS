...
initialization
  ...
  VKStr[19] := 'K_PAUSE';
  VKStr[20] := 'K_CAPS';
  for kbi:= 21{ $15} to 26{ $1A} do VKStr[kbi] := '';
  VKStr[27] := 'K_ESC';
  for kbi:= 28{ $1C} to 31{ $1F} do VKStr[kbi] := '';
  VKStr[32] := 'K_SPACE';
  VKStr[33] := 'K_PGUP';
  VKStr[34] := 'K_PGDN';
  VKStr[35] := 'K_END';
  ...
  VKStr[56] := 'K_8';
  VKStr[57] := 'K_9';
  for kbi:= 56{ $3A} to 64{ $40} do VKStr[kbi] := '';
  VKStr[65] := 'K_A';
  VKStr[66] := 'K_B';
  VKStr[67] := 'K_C';
  VKStr[68] := 'K_D';
  ...
  VKStr[104] := 'K_NUMPAD8';
  VKStr[105] := 'K_NUMPAD9';
  VKStr[106] := 'K_MULTIPLY';
  VKStr[107] := 'K_ADD';
  VKStr[108] := 'K_SEPARATOR';
  VKStr[109] := 'K_SUBTRACT';
  VKStr[110] := 'K_DECIMAL';
  VKStr[111] := 'K_DIVIDE';
  VKStr[112] := 'K_F1';
  VKStr[113] := 'K_F2';
  ...
  VKStr[134] := 'K_F23';
  VKStr[135] := 'K_F24';
  for kbi:= 136{ $88} to 143{ $8F} do VKStr[kbi] := '';
  VKStr[144] := 'K_NUMLOCK';
  VKStr[145] := 'K_SCROLL';
  for kbi:= 146{ $92} to 185{ $B9} do VKStr[kbi] := '';
  VKStr[186] := 'K_OEM_1';      // ;:
  VKStr[187] := 'K_OEM_PLUS';   // =+
  VKStr[188] := 'K_OEM_COMMA';  // ,<
  VKStr[189] := 'K_OEM_MINUS';  // -_
  VKStr[190] := 'K_OEM_PERIOD'; // .>
  VKStr[191] := 'K_OEM_2';    // /?
  VKStr[192] := 'K_OEM_3';    // '@
  for kbi:= 193{ $C1} to 218{ $DA} do VKStr[kbi] := '';
  VKStr[219] := 'K_OEM_4';     // [{
  VKStr[220] := 'K_OEM_5';     // \|
  VKStr[221] := 'K_OEM_6';     // ]}
  VKStr[222] := 'K_OEM_7';     // #~
  VKStr[223] := 'K_OEM_8';     // `¬
  VKStr[224] := 'K_F17';       // on Olivetti extended keyboard
  VKStr[225] := 'K_OEM_AX';
  VKStr[226] := 'K_OEM_102';
  VKStr[227] := 'K_ICO_HELP';  // on Olivetti extended keyboard
  VKStr[228] := 'K_ICO_00';    // on Olivetti extended keyboard
  VKStr[229] := 'K_PROCESSKEY';
  VKStr[230] := 'K_ICO_CLEAR'; // on Olivetti extended keyboard
  VKStr[231] := '';
  VKStr[232] := '';
  VKStr[233] := 'K_OEM_RESET';   // only used by Nokia
  VKStr[234] := 'K_OEM_JUMP';    // only used by Nokia
  VKStr[235] := 'K_OEM_PA1';     // only used by Nokia
  VKStr[236] := 'K_OEM_PA2';     // only used by Nokia
  VKStr[237] := 'K_OEM_PA3';     // only used by Nokia
  VKStr[238] := 'K_OEM_WSCTRL';  // only used by Nokia
  VKStr[239] := 'K_OEM_CUSEL';   // only used by Nokia
  VKStr[240] := 'K_OEM_ATTN';    // only used by Nokia
  VKStr[241] := 'K_OEM_FINNISH'; // only used by Nokia
  VKStr[242] := 'K_OEM_COPY';    // only used by Nokia
  VKStr[243] := 'K_OEM_AUTO';    // only used by Nokia
  VKStr[244] := 'K_OEM_ENLW';    // only used by Nokia
  VKStr[245] := 'K_OEM_BACKTAB'; // only used by Nokia
  VKStr[246] := 'K_ATTN';
  VKStr[247] := 'K_CRSEL';
  VKStr[248] := 'K_EXSEL';
  VKStr[249] := 'K_EREOF';
